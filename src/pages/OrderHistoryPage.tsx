          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-left p-4">รหัสประจำตัว</th>
                <th className="text-left p-4">ชื่อ</th>
                <th className="text-left p-4">รายการ</th>
                <th className="text-right p-4">กำหนด</th>
              </tr>
            </thead>
            <tbody>
              {sortedHistory.map((record) => (
                <tr key={record._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="p-4">{record.documentNo}</td>
                  <td className="p-4">{record.location}</td>
                  <td className="p-4">{record.personId}</td>
                  <td className="p-4">{record.personName}</td>
